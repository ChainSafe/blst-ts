 ...
 * @throw {Error} - Invalid aggregation
 */
export declare function aggregateVerify(msgs: BlstBuffer[], publicKeys: PublicKeyArg[], signature: SignatureArg): boolean;
/**
 ...
 * @throw {Error} - Invalid aggregation
 */
export declare function asyncAggregateVerify(msg: BlstBuffer[], publicKey: PublicKeyArg[], signature: SignatureArg): Promise<boolean>;
/**
 * Bls batch verification for groups with a message and corresponding public key
 * and signature. Only returns true if all signatures are valid.
 *
