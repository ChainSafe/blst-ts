...
blst_ts::BLST_TS_ERROR prepare_aggregate_with_randomness(
    ...
    for (uint32_t i = 0; i < sets_length; i++) {
        sets.push_back({nullptr, nullptr, 0});
...
//         if (!set_value.IsObject()) {
//             Napi::TypeError::New(
//                 env, "Must pass an array of objects to
//                 aggregateWithRandomness") .ThrowAsJavaScriptException();
//             return env.Undefined();
//         }
//         Napi::Object set = set_value.As<Napi::Object>();
...
//                     return env.Undefined();
//                 } else {
//                     blst::P1 key{typed_array.Data(),
//                     typed_array.ByteLength()}; if (validate && (key.is_inf()
//                     || !key.in_group())) {
//                         Napi::Error::New(
//                             env,
...
//                     Napi::TypeError::New(
//                         env,
//                         "BLST_ERROR: SignatureArg must not be zero
//                         signature") .ThrowAsJavaScriptException();
//                     return env.Undefined();
//                 } else {
//                     blst::P2 sig{typed_array.Data(),
//                     typed_array.ByteLength()}; if (validate &&
//                     !sig.in_group()) {
//                         Napi::Error::New(
//                             env,
