...
#define BLST_TS_SECRET_KEY_LENGTH 32UL
#define BLST_TS_PUBLIC_KEY_LENGTH_UNCOMPRESSED 48UL
#define BLST_TS_PUBLIC_KEY_LENGTH_COMPRESSED 96UL
#define BLST_TS_SIGNATURE_LENGTH_UNCOMPRESSED 96UL
#define BLST_TS_SIGNATURE_LENGTH_COMPRESSED 192UL
#define BLST_TS_RANDOM_BYTES_LENGTH 8UL

#define BLST_TS_SECRET_KEY_LOWER_TAG 0UL
#define BLST_TS_SECRET_KEY_UPPER_TAG 1UL
#define BLST_TS_PUBLIC_KEY_LOWER_TAG 2UL
#define BLST_TS_PUBLIC_KEY_UPPER_TAG 3UL
#define BLST_TS_SIGNATURE_LOWER_TAG 4UL
#define BLST_TS_SIGNATURE_UPPER_TAG 5UL
